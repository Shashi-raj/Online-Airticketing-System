...
<body>
    <img class="logo" src="images/plane.png" />
    <h1 id="title">
        Airlines
    </h1>
    <div>
            ...
            <div id="divtop">
                <center>
                    ...
                    <div id="dmain">
                        ...
                        <button type="button" onclick="location.href = './index.html';" class="toggle btn btn-primary" style="width:100px; margin-left: 70px;">Back to Portal</button>
                        <br>
