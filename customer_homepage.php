  ...
  <body>
    ...
    <div class="row">
      <div class="col-3 menu">
        ...
        <a href="view_booked_tickets.php">Your-Bookings</a>
        <a href="pnr.php">Print-Ticket</a>
        <a href="cancel_book_tickets.php">Cancel-Ticket</a>
        <a href="book_tickets.php">View Flights</a>
